...
const banner2 = cfonts.render((`© 2023 Copyright by Gleyson Bots`), {
font: 'console',
align: 'center',
gradient: ['red', 'magenta']
});
 
const banner = cfonts.render((`KITAGAWA|BOT`), {
  font: 'block',
  align: "center",
  gradient: ['black', 'magenta']
});
 const banner3 = cfonts.render((`KITAGAWA-MD`), {
font: 'slick',             
align: 'center',           
...
const authorname = "Muzan Multi-Device"
const packname = "Criador: @xxAlan 愛"

const chyt = "551592754231@s.whatsapp.net";
const nit = "551592754231@s.whatsapp.net";
const supre = "551592754231@s.whatsapp.net";
